...
export default function MediaCategoryMenu() {
        ...
        <div className="space-y-4">
            ...
            <div className="flex flex-wrap items-center gap-2">
                {items.map((item) => {
                    ...
                    const path =
                        activeTab === "countries"
                            ? `/vod/country/${id}?source=${atob("c291cmNlX28=")}`
                            : `/vod/category/${id}?source=${atob("c291cmNlX28=")}`;
                    ...
                    return (
                        <Link
                            ...
                            className={`rounded-full px-4 py-1.5 text-xs font-bold transition-all ${
                                isSelected
                                    ? "bg-primary-600 text-white shadow-[0_0_15px_rgba(245,184,0,0.4)]"
